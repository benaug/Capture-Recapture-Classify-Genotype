...
source("map.genos.R")
source("NimbleModel M0 SNP.R")
source("Nimble Functions M0 SNP.R")
...
p.geno.het <- c(0.85,0.15) #P(correct, allelic dropout) for heterozygotes
p.geno.hom <- c(0.85,0.15) #P(correct,false allele) for homozygotes
...
#                     type = 'GSampler',
#                     control = list(i = i,m=m,n.rep=n.rep,
...
conf$addSampler(target = paste0("G.true[1:",M,",1:",n.loci,"]"),
                type = 'GSampler2',
                control = list(M=M,n.loci=n.loci,n.rep=n.rep,
